...
| Area | What | Doc |
|---|---|---|
| Search & matching | Whole season searched once in background ([ADR-0005](docs/adr/0005-search-whole-season-once.md)); parallel per-indexer Jackett fetch; matchScore-as-gate then quality+availability ranking; strict word-count title matching + TMDB English-title fetch | [`scoring-model.md`](docs/reference/torrent-mod-scoring-model.md), [`parallel-search.md`](docs/system-design/torrent-mod-parallel-search.md), [`search-architecture.md`](docs/system-design/torrent-mod-search-architecture.md) (целевое состояние + замеры) |
